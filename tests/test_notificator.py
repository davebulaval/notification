...
class SlackNotificatorTest(unittest.TestCase):
    def setUp(self):
        ...
        self.slack_notificator = SlackNotificator(self.a_fake_web_hook,
    ...
    def test_givenASlackNotificator_whenSendNotification_thenSendMessageDefaultSubject(self, requests_mock):
        self.slack_notificator.send_notification(self.a_notification)
...
class EmailNotificatorTest(unittest.TestCase):
    ...
    def test_givenAEmailNotificator_whenSendNotification_thenSendMessageDefaultSubject(self):
        ...
        post_call = [
            ...
            call.sendmail(self.a_fake_sender_email, self.a_fake_destination_email, expected_content)
        ]
    ...
    def test_givenAEmailNotificator_whenSendNotificationDoesNotWork_thenWaitTimer(self):
        a_mock_smtp_server = MagicMock()
        a_mock_smtp_server.sendmail.side_effect = SMTPRecipientsRefused('a_fake_recipientss')
